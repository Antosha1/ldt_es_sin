...
from es_sin.competitor_discount import discount_scores
import pandas as pd
import numpy as np


def get_best_location(product, possible_locations, valuable_features, sc):
    columns = get_columns()
    ...
    res_list = discount_scores(product, res_list)
